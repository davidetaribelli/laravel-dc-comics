                ...
                <div class="col-7 my-3">
                    <form action="{{route('cards.store')}}" method="POST">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            ...
                            <input type="text" name="title" placeholder="Insert title" class="px-2 py-1 border-0 rounded-end">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <label class="text-white input-group-text bg_blue me-3 border-0" for="description">Description</label>
                            <input type="text" name="description" placeholder="Insert description" class="px-2 py-1 border-0 rounded-end">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <label class="text-white input-group-text bg_blue me-3 border-0" for="thumb">Thumb</label>
                            <input type="text" name="thumb" placeholder="Insert thumb" class="px-2 py-1 border-0 rounded-end">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <label class="text-white input-group-text bg_blue me-3 border-0" for="price">Price</label>
                            <input type="text" name="price" placeholder="Insert price" class="px-2 py-1 border-0 rounded-end">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <label class="text-white input-group-text bg_blue me-3 border-0" for="series">Series</label>
                            <input type="text" name="series" placeholder="Insert series" class="px-2 py-1 border-0 rounded-end">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <label class="text-white input-group-text bg_blue me-3 border-0" for="sale_date">Sale_date</label>
                            <input type="text" name="sale_date" placeholder="Insert sale_date" class="px-2 py-1 border-0 rounded-end">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <label class="text-white input-group-text bg_blue me-3 border-0" for="type">Type</label>
                            <input type="text" name="type" placeholder="Insert type" class="px-2 py-1 border-0 rounded-end">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <label class="text-white input-group-text bg_blue me-3 border-0" for="artists">Artists</label>
                            <input type="text" name="artists" placeholder="Insert artists" class="px-2 py-1 border-0 rounded-end">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <label class="text-white input-group-text bg_blue me-3 border-0" for="writers">Writers</label>
                            <input type="text" name="writers" placeholder="Insert writers" class="px-2 py-1 border-0 rounded-end">
                        </div>
